...
4. ✅ admin user 已建立()
5. ✅ 10 core Agent 已建立( collection ≥ 10)
...
- release-verify.sh 失敗 · 2 項 · log=/tmp/release-verify-clean.log
...
把這些都放進 `reports/clean-install/2026-04-25/` · 跟此 manifest 同 commit。
