...
- `/Users/sterio/Workspace/ChengFu/reports/release/release-manifest-2026-04-28-223907.md`
- DMG:`/Users/sterio/Workspace/ChengFu/installer/dist/ChengFu-AI-Installer.dmg`
...
6. `backup.sh` 在沒有 GPG key `chengfu` 時預設 fail-loud,只允許明確 `ALLOW_PLAINTEXT_BACKUP=1` 的本機開發備份。
...
- `/Users/sterio/Workspace/ChengFu/reports/release/release-manifest-2026-04-28-201256.md:17`
- `/Users/sterio/Workspace/ChengFu/reports/release/release-manifest-2026-04-28-201256.md:31`
- `/Users/sterio/Workspace/ChengFu/reports/release/release-manifest-2026-04-28-201256.md:33`
...
- `/Users/sterio/Workspace/ChengFu/tests/e2e/critical-journeys.spec.ts:197`
- `/Users/sterio/Workspace/ChengFu/tests/e2e/critical-journeys.spec.ts:206`
- `/Users/sterio/Workspace/ChengFu/tests/e2e/view-coverage.spec.ts:121`
- `/Users/sterio/Workspace/ChengFu/tests/e2e/view-coverage.spec.ts:134`
...
- `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/notebooklm.py:179`
- `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/notebooklm.py:185`
- `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/notebooklm.py:609`
- `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/notebooklm.py:926`

但 action specs 沒有暴露 `X-Acting-User`,sync request body 也缺 `confirm_send_to_notebooklm`:

- `/Users/sterio/Workspace/ChengFu/config-templates/actions/notebooklm-bridge.json:28`
- `/Users/sterio/Workspace/ChengFu/config-templates/actions/internal-services.json:423`
- `/Users/sterio/Workspace/ChengFu/config-templates/actions/internal-services.json:576`
- `/Users/sterio/Workspace/ChengFu/config-templates/actions/internal-services.json:591`
...
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:474`
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:479`
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:644`
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/router.js:49`

NotebookLM 每次 render/bind 都對同一 root 加 click listener,重複切頁後可能造成同步/複製重複觸發:

- `/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/notebooklm.js:67`
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/notebooklm.js:334`
- `/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/notebooklm.js:376`
...
備份腳本已改為沒有 GPG key `chengfu` 時直接中止,除非明確 `ALLOW_PLAINTEXT_BACKUP=1`。明文 fallback 不再是正式預設。
...
- `/Users/sterio/Workspace/ChengFu/reports/clean-install/clean-install-verify-2026-04-28-094351.md:7`
- `/Users/sterio/Workspace/ChengFu/reports/clean-install/clean-install-verify-2026-04-28-094351.md:17`
- `/Users/sterio/Workspace/ChengFu/reports/clean-install/clean-install-verify-2026-04-28-094351.md:48`
...
1. `/admin/storage-stats` 監控 collection 名稱錯誤。Dashboard 監控 `transactions/invoices/quotes`,但實際會計 collection 是 `accounting_transactions/accounting_invoices/accounting_quotes/accounting_projects_finance`。參考 `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/admin/dashboard.py:45` 與 `/Users/sterio/Workspace/ChengFu/backend/accounting/main.py:65`。

2. NotebookLM resume 判斷只看 `batch_id + relative_path + status`,沒有納入 `project_id/notebook_id`。跨專案重用 batch id 可能錯誤跳過檔案。參考 `/Users/sterio/Workspace/ChengFu/backend/accounting/routers/notebooklm.py:367`。

3. 首頁把 inspector 完全隱藏,但 init 仍等待 conversations / usage / ROI 等資料載入後才顯示 app。參考 `/Users/sterio/Workspace/ChengFu/frontend/launcher/launcher.css:172`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/index.html:803`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:189`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:231`。

4. `⌘K` palette 缺 dialog/listbox 語意、focus restore 與 active descendant。參考 `/Users/sterio/Workspace/ChengFu/frontend/launcher/index.html:987`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/palette.js:24`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/palette.js:73`。

5. Project drawer 是 modal 行為,但沒有 `role="dialog"`、`aria-modal` 與 focus trap。參考 `/Users/sterio/Workspace/ChengFu/frontend/launcher/index.html:856`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:1761`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:1843`。

6. 動態 HTML 仍有 inline handler 殘留,事件模型尚未完全統一。參考 `/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/chat.js:1098`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/modules/chat.js:1100`、`/Users/sterio/Workspace/ChengFu/frontend/launcher/app.js:720`。
...
8. `api-types.ts` 仍是 bootstrap placeholder,不是真正由 backend OpenAPI 產生的型別。參考 `/Users/sterio/Workspace/ChengFu/frontend/launcher/lib/api-types.ts:1`。

9. 安裝包與外部可見文件仍有固定「承富 / ChengFu」字樣,與 D-016 白標決策衝突。參考 `/Users/sterio/Workspace/ChengFu/docs/DECISIONS.md:123`、`/Users/sterio/Workspace/ChengFu/installer/build.sh:21`、`/Users/sterio/Workspace/ChengFu/installer/build.sh:84`、`/Users/sterio/Workspace/ChengFu/installer/build.sh:140`。
...
2. 現場建立 GPG key `chengfu`,跑一次 `scripts/backup.sh` 確認只產 `.gpg`。
