...
SKILL_MAP = {
    "00": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14", "15"],  # 主管家全套
    "01": ["01", "02", "03", "10"],          # 投標
    "02": ["07", "08", "09", "12", "14"],    # 活動 (+ 14 危機處理)
    "03": ["08"],                              # 設計(視覺面)
    "04": ["04", "05", "06", "11", "13"],    # 公關 (+ 13 客戶破冰)
    "05": ["06"],                              # 會議速記
    "06": ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14", "15"],  # 知識庫全套
    "07": ["09", "10"],                       # 財務
    "08": ["02", "06", "10"],                # 法務
    "09": ["11", "12", "15"],                # 結案營運 (+ 15 KPI)
}
